...
const MODULES = [
  { id: 'tasks', name: 'Tasks', nameEs: 'Tareas', description: 'Gestion de tareas operativas', icon: 'ClipboardList', color: '#007AFF', route: '/tasks', isActive: true, isVisible: true, order: 1, category: 'operations', requiredPermission: 'canViewModuleTasks', isSystem: true, createdAt: new Date().toISOString(), createdBy: 'system' },
  { id: 'horarios', name: 'Horarios', nameEs: 'Horarios', description: 'Asignacion de turnos y gestion de horarios', icon: 'Clock', color: '#5856D6', route: '/horarios', isActive: true, isVisible: true, order: 2, category: 'operations', requiredPermission: 'canViewModuleHorarios', isSystem: true, createdAt: new Date().toISOString(), createdBy: 'system' },
  { id: 'reportes', name: 'Reportes', nameEs: 'Reportes', description: 'Generacion y consulta de reportes', icon: 'FileText', color: '#34C759', route: '/reportes', isActive: true, isVisible: true, order: 3, category: 'management', requiredPermission: 'canViewModuleReportes', isSystem: true, createdAt: new Date().toISOString(), createdBy: 'system' },
  { id: 'ordenes-pago', name: 'Ordenes de Pago', nameEs: 'Ordenes de Pago', description: 'Gestion de ordenes de pago', icon: 'CreditCard', color: '#FF9500', route: '/ordenes-pago', isActive: true, isVisible: true, order: 4, category: 'financial', requiredPermission: 'canViewModuleOrdenesPago', isSystem: true, createdAt: new Date().toISOString(), createdBy: 'system' },
  { id: 'dive-ops', name: 'Dive Ops', nameEs: 'Operaciones de Buceo', description: 'Gestion de operaciones de buceo', icon: 'IdCard', color: '#5AC8FA', route: '/dive-ops', isActive: true, isVisible: true, order: 5, category: 'operations', requiredPermission: 'canViewModuleDiveOps', isSystem: true, createdAt: new Date().toISOString(), createdBy: 'system' },
  { id: 'requisiciones', name: 'Requisiciones', nameEs: 'Requisiciones', description: 'Gestion de requisiciones y compras', icon: 'ShoppingCart', color: '#FFCC00', route: '/requisiciones', isActive: true, isVisible: true, order: 6, category: 'logistics', requiredPermission: 'canViewModuleRequisiciones', isSystem: true, createdAt: new Date().toISOString(), createdBy: 'system' },
  { id: 'movilidad', name: 'Movilidad', nameEs: 'Movilidad', description: 'Gestion de transporte', icon: 'Car', color: '#FF3B30', route: '/movilidad', isActive: true, isVisible: true, order: 7, category: 'logistics', requiredPermission: 'canViewModuleMovilidad', isSystem: true, createdAt: new Date().toISOString(), createdBy: 'system' },
  { id: 'vessels', name: 'Vessels', nameEs: 'Embarcaciones', description: 'Gestion de embarcaciones', icon: 'Anchor', color: '#AF52DE', route: '/vessels', isActive: true, isVisible: true, order: 8, category: 'operations', requiredPermission: 'canViewModuleVessels', isSystem: true, createdAt: new Date().toISOString(), createdBy: 'system' },
  { id: 'develops', name: 'Develops', nameEs: 'Administracion', description: 'Panel maestro de control', icon: 'Code2', color: '#1D1D1F', route: '/develops', isActive: true, isVisible: false, order: 99, category: 'admin', requiredPermission: 'canViewModuleDevelops', isSystem: true, createdAt: new Date().toISOString(), createdBy: 'system' },
];
