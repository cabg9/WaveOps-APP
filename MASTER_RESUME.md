...
> Última actualización: 2026-08-15 (Incapacidades móvil: filtros con ancho completo bajo sub-pestañas; deployado)
...
- **HorariosModule**:
  ...
  - **Correcciones puntuales solicitadas**:
    ...
    - **Solicitudes (móvil)**:
      ...
      - En móvil, los dropdowns de filtros de **Incapacidades** ahora se apilan verticalmente (`flex-col`) y ocupan el ancho completo (`w-full`), dejando el dropdown de estado directamente bajo las sub-pestañas.
- **TasksModule**:
