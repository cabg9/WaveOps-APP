...
> Última actualización: 2026-08-15 (Incapacidades móvil: dropdown de estado bajo sub-pestañas; deployado)
...
- **HorariosModule**:
  ...
  - **Correcciones puntuales solicitadas**:
    ...
    - **Solicitudes (móvil)**:
      ...
      - En móvil, los dropdowns de filtros de **Incapacidades** ahora se apilan verticalmente (`flex-col`), dejando el dropdown de estado directamente bajo las sub-pestañas.
- **TasksModule**:
