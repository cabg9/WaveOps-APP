...
- **HorariosModule**:
  ...
  - **Correcciones puntuales solicitadas**:
    ...
    - **Mi Horario (móvil)**: número del día reducido a `text-sm` y bajado con `mt-2` para que no lo cubra el ícono de asignación/incapacidad en la esquina superior derecha.
- **TasksModule**:
